...
import 'package:professor_interface/Models/teacher_model.dart';
import 'package:professor_interface/screens/add_attendance.dart';
...
class _DashboardState extends State<Dashboard> {
  ...
  Future<Teacher> getProfile() async {
    final json =
        await getData("view_teacher.php", params: {"teacher_id": "26"});
    print(json);
